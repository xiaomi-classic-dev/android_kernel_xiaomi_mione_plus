...
#if defined(CONFIG_HAPTIC_ISA1200_MIONE) || \
...
#ifdef CONFIG_TOUCHSCREEN_ATMEL_MXT_MIONE
...
#ifdef CONFIG_TOUCHSCREEN_SYNAPTICS_I2C_RMI4_MIONE
...
#ifdef CONFIG_SENSORS_LIS3DH_MIONE
...
#endif
#if defined(CONFIG_TOUCHSCREEN_ATMEL_MXT_MIONE)
	{
	 I2C_SURF | I2C_FFA,
	 MSM_GSBI8_QUP_I2C_BUS_ID,
	 atmel_mxt_i2c_info,
...
#endif
#if defined(CONFIG_TOUCHSCREEN_SYNAPTICS_I2C_RMI4_MIONE)
	{
	 I2C_SURF | I2C_FFA,
	 MSM_GSBI8_QUP_I2C_BUS_ID,
	 synaptics_i2c_info,
