...
#else
static inline unsigned int get_powerup_reason(void)
{
	return 0;
}

static inline int is_abnormal_powerup(void)
{
	return 0;
}

static inline void set_powerup_reason(unsigned int powerup_reason)
{
}
#endif
