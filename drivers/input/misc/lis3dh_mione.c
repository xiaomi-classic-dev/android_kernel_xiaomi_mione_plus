...
#ifdef CONFIG_SENSORS_LIS3DH_EARLYSUSPEND_MIONE
...
#if defined(CONFIG_PM) || defined(CONFIG_SENSORS_LIS3DH_EARLYSUSPEND_MIONE)
...
#ifndef CONFIG_SENSORS_LIS3DH_EARLYSUSPEND_MIONE
